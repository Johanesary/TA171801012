...
directoryDirect = 'D:/FTP/localization/direct'; #Path to the target file
directoryReference = 'D:/FTP/localization/reference'
#directory = 'D:\.TUGAS AKHIR\FTP-Folder'; #Path to the target file

RECORD_SECONDS = 1
#CHUNK = 1024
jarak = 0
fname1 = directoryReference + '/data.wav'
fname2 = directoryDirect + '/data.wav'
gain = 10
